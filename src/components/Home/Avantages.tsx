export default function Avantages() {
    return (
        <>
            {/* Avantages */}
            <section className="px-[24px] md:px-[48px] py-[40px] md:py-[80px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[16px] text-base dark:text-[#0C1A2E] md:text-lg leading-[1.4]">
                <div className="p-[24px] bg-[#F9F9F9] dark:bg-[#EAE2D7] flex flex-col justify-between place-items-center md:place-items-start text-center md:text-left h-[160px] md:h-[200px]">
