    ...
    return (
        <section className="px-[24px] md:px-[48px] py-[40px] md:pt-[128px] md:pb-[80px] flex flex-col gap-[32px] md:gap-[48px]">
            ...
            <motion.div
                ...
                className="grid grid-cols-1 lg:grid-cols-3 gap-[16px] md:gap-[24px]"
            >
                {/* Card avis */}
                {avis.map((item, index) => (
                    <motion.div
                        ...
                        className="p-[16px] md:p-[24px] bg-[#F9F9F9] dark:bg-[#F5F3EF] dark:text-[#0C1A2E] flex flex-col justify-between gap-[24px] md:gap-[40px] w-full">
                        {/* Titre + avis */}
