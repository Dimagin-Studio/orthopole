        ...
        <>
            ...
            <section className="px-4 md:px-[48px] py-[40px] md:py-[80px] flex flex-col gap-[32px] md:gap-[48px]">
                ...
                <div className="flex flex-col gap-[16px] md:gap-[24px] items-center text-center">
                    ...
                    <h2 className="text-3xl md:text-5xl tracking-tight leading-[1.2] md:leading-[1.4]">
                        Découvrez nos services
                    </h2>
                </div>

                {/* <!-- Container --> */}
                <div className="text-[#F5F3EF] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[24px]">
                    {/* <!-- Box service 1 --> */}
                    <div className="w-full h-[340px] md:h-[460px] flex flex-col gap-[8px] p-[24px] justify-end bg-cover bg-center bg-no-repeat"
                        ...
                        <p className="text-sm leading-[1.3]">Réparer et restaurer la mobilité</p>
                    </div>
                    ...
                    <div className="w-full h-[340px] md:h-[460px] flex flex-col gap-[8px] p-[24px] justify-end bg-cover bg-center bg-no-repeat"
                        ...
                        <p className="text-sm leading-[1.3]">Diagnostique précis par imagerie</p>
                    </div>
                    ...
                    <div className="w-full h-[340px] md:h-[460px] flex flex-col gap-[8px] p-[24px] justify-end bg-cover bg-center bg-no-repeat"
                        ...
                        <p className="text-sm leading-[1.3]">Renforcer et rééduquer le corps</p>
                    </div>
                    ...
                    <div className="w-full h-[340px] md:h-[460px] flex flex-col gap-[8px] p-[24px] justify-end bg-cover bg-center bg-no-repeat"
                        ...
                        <p className="text-sm leading-[1.3]">Récupérer pleinement ses capacités</p>
                    </div>
                </div>
            </section>
        </>
