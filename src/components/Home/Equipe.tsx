...
const practiciens = [
  ...
  {
    src: "/images/photos-practicien/thibaut.jpeg",
    alt: "Dr. Thibaut Leemrijse",
    name: "Dr. Thibaut Leemrijse",
    specialty: "CHIRURGIE DU PIED ET DE LA CHEVILLE",
    mt: "",
  },
  {
    src: "/images/photos-practicien/DR-TOUSSAINT-whitebg.jpg",
    alt: "Dr. Juan Toussaint",
    name: "Dr. Juan Toussaint",
    specialty: "CHIRURGIE DE LA COLONNE",
    mt: "mt-0 md:mt-[80px]",
  },
  {
    src: "/images/photos-practicien/docteur-geulette.JPG",
    alt: "Dr. Bernard Geulette",
  ...
  // Kinésithérapeutes
  {
    src: "/images/photos-kines/alexis-de-wael.jpeg",
    alt: "Alexis De Wael",
    name: "Alexis De Wael",
  ...
  {
    src: "/images/photos-kines/françois-dessart.JPG",
    alt: "François Dessart",
    name: "François Dessart",
    specialty: "KINÉSITHÉRAPEUTE",
    mt: "mt-0 md:mt-[80px]",
  },
  {
    src: "/images/photos-kines/vanina-ullens.jpeg",
    alt: "Vanina Ullens",
    name: "Vanina Ullens",
    specialty: "KINÉSITHÉRAPEUTE",
    mt: "mt-0 md:mt-[40px]",
  ...
  {
    src: "/images/photos-figma/sylvie-machiels.png",
    alt: "Sylvie Machiels",
  ...
  {
    src: "/images/photos-kines/strength-care.png",
    alt: "Anne-Sophie Brysse",
    ...
    <section className="px-[24px] md:px-[48px] pt-[40px] md:pt-[80px] pb-[64px] md:pb-[128px] flex flex-col gap-[40px] md:gap-[80px]">
      ...
      <div className="flex flex-col gap-[16px] md:gap-[24px] items-center text-center">
        ...
        <h2 className="max-w-[90%] md:max-w-[768px] text-3xl md:text-4xl lg:text-5xl leading-[1.4] tracking-tight">
          Une équipe de spécialistes engagés dans une prise en charge
          personnalisée.
        </h2>
      </div>
      ...
      <Link to="/equipes">
        <MotionButton
          as="div"
          className="w-full md:w-fit mx-auto px-[16px] md:px-[20px] lg:px-[24px] py-[8px] md:py-[10px] text-[#FBF8F3] dark:text-[#0C1A2E] bg-[#0C1A2E] hover:bg-[#172D47] dark:bg-[#C9BBA8] dark:hover:bg-[#ac9c86] font-medium text-center leading-[23.48px]"
        >
          DÉCOUVRIR L'ÉQUIPE
        </MotionButton>
      </Link>
