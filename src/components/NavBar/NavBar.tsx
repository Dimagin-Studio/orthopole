...
export default function NavBar() {
    return (
        <>
            <nav className="w-full px-4 md:px-[48px] py-[16px] text-lg flex flex-col md:flex-row gap-y-[16px] md:gap-y-0 gap-x-[16px] md:gap-x-[32px] md:items-center justify-items-start md:justify-between text-center">
                ...
                <Hamburger>
                    <>
                        ...
                        <div className="md:hidden flex flex-col gap-6 w-full">
                            <ul className="flex flex-col gap-[24px] font-semibold text-[#FBF8F3] leading-[1.4] list-none w-full text-center">
                                <li><Link to="/specialites">Nos spécialités</Link></li>
                                <li><a href="">Nos équipes</a></li>
