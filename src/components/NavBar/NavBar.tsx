        ...
        <>
            <Hamburger>
                <div className="flex flex-col lg:flex-row gap-6 items-center w-full">
                    {/* <ul> centré */}
                    <ul className="flex flex-col lg:flex-row gap-[24px] justify-center items-center font-semibold text-[#FBF8F3] lg:text-[#0C1A2E] leading-[1.4] list-none text-center w-full max-w-[1200px]">
                    ...
                    {/* Bouton "RENDEZ-VOUS" */}
                    <Link to="/infos#contact-form" className="w-full lg:w-fit ml-auto lg:ml-0">
